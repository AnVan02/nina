<?php
	...
	if(isset($_POST['thanhtoan']))
	{
	    ...
	    for($i=0;$i<$max;$i++)
	    {
			...
			$pricenew=$cart->total_get_price($pid,$q);
			$textsm='';
	    	...
	    	if(isset($_SESSION[$login_member]) && $proinfo['giasi']>0){
	    		$chitietdonhang.='<td align="left" style="padding:3px 9px" valign="top"><span style="color:#ff0000;">'.$func->format_money($proinfo['giasi']).'</span></td>';
	    	...
	    	if(isset($_SESSION[$login_member]) && $proinfo['giasi']>0){
	    		$chitietdonhang.='<td align="right" style="padding:3px 9px" valign="top"><span style="color:#ff0000;">'.$func->format_money($proinfo['giasi']*$q).'</span>
	    		<br/><span>'.$cart->get_sale_price($pid,$q).'</span>
	    		<br/><span style="color:#ff0000;">'.$func->format_money($pricenew).'</span></td>';
	    	}elseif($proinfo['giamoi'])
	    	{
		...
		if($id_insert)
		{
			for($i=0;$i<$max;$i++)
			{
				...
				$data_donhangchitiet['giasi'] = $giasi;
