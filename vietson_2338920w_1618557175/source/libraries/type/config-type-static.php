<?php
    ...
    $nametype = "chuong-trinh-khuyen-mai";
    $config['static'][$nametype]['title_main'] = "Chương Trình Khuyến Mãi";
    ...
    $config['static'][$nametype]['width'] = 665;
    $config['static'][$nametype]['height'] = 570;
    ...
    // $config['static'][$nametype]['noidung_cke'] = true;
    // $config['static'][$nametype]['seo'] = true;
    // $config['static'][$nametype]['sitemap'] = true;
    // $config['static'][$nametype]['seopage'] = true;
