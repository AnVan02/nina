    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="card card-primary card-outline text-sm">
                    <div class="card-header">
                        <h3 class="card-title">Chọn hãng sản xuất</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group-category">
                            <?=$func->get_list(@$item['id'], 'list_group', 'product_cat', $type)?>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-primary card-outline text-sm">
                    <div class="card-header">
                        <h3 class="card-title">Chọn thuộc tính</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group-category">
                            <?=$func->get_properties(@$item['id'], 'properties_group', 'product_cat', $type)?>
                        </div>
                    </div>
                </div>
