	            ...
	            <div class="card-body">
		            ...
		            <?php if(isset($config[$com][$type][$dfgallery][$val]['soluongtu']) && $config[$com][$type][$dfgallery][$val]['soluongtu'] == true) { ?>
				    	<div class="form-group col-md-6">
	                        ...
	                        <div class="input-group">
	                        	<input type="number" min="0" class="form-control format-price" name="dataMulti[<?=$i?>][soluongtu]" id="soluongtu" placeholder="Số lượng từ" >
	                        </div>
	                    </div>
				    <?php } ?>
				    <?php if(isset($config[$com][$type][$dfgallery][$val]['soluongden']) && $config[$com][$type][$dfgallery][$val]['soluongden'] == true) { ?>
				    	<div class="form-group col-md-6">
	                        ...
	                        <div class="input-group">
	                        	<input type="number" min="0" class="form-control format-price" name="dataMulti[<?=$i?>][soluongden]" id="soluongden" placeholder="Số lượng đến" >
	                        </div>
	                    </div>
				    <?php } ?>
				    <?php if(isset($config[$com][$type][$dfgallery][$val]['phantram']) && $config[$com][$type][$dfgallery][$val]['phantram'] == true) { ?>
				    	<div class="form-group col-md-6">
	                        ...
	                        <div class="input-group">
	                        	<input type="number" min="0" class="form-control format-price" name="dataMulti[<?=$i?>][phantram]" id="phantram" placeholder="Phần trăm" >
	                        </div>
	                    </div>
				    <?php } ?>
				    <?php if(isset($config[$com][$type][$dfgallery][$val]['giagiam']) && $config[$com][$type][$dfgallery][$val]['giagiam'] == true) { ?>
				    	<div class="form-group col-md-6">
	                        ...
	                        <div class="input-group">
	                        	<input type="text" class="form-control format-price gia_ban" name="dataMulti[<?=$i?>][giagiam]" id="giagiam" placeholder="Giá giảm" >
				    ...
				    <div class="form-group col-sm-6">
                        ...
                        <select class="form-control" name="dataMulti[<?=$i?>][tuychon]" id="tuychon">
