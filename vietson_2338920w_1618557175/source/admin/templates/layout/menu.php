                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <?php if(!empty($v['dropdown'])) { if(isset($v['list']) && $v['list'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_list&type=<?=$k?>" title="Hãng sản xuất"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Hãng sản xuất</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['cat']) && $v['cat'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_cat&type=<?=$k?>" title="Loại sản phẩm"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Loại sản phẩm</p></a></li>
                                        <?php } ?>
                                        ...
                                        <?php if(isset($v['brand']) && $v['brand'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_brand&type=<?=$k?>" title="Thuộc tính sản phẩm"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Thuộc tính sản phẩm</p></a></li>
                                        <?php } ?>
