	                            ...
	                            <tr>
	                                ...
	                                <td class="align-middle text-center">
	                                	<div class="price-cart-detail">
	                                		<?php if($v['giasi']>0){?>
												<span class="price-new-cart-detail"><?=$func->format_money($v['giasi'])?></span>
	                                ...
	                                <td class="align-middle text-right">
	                                	<div class="price-cart-detail">
	                                		<?php if($v['giasi']>0){?>
	                                			<span class="price-new-cart-detail"><?=$func->format_money($v['giasi']*$v['soluong'])?></span>
	                                			<?php if($item['id_user']>0){?>
													<span class="price-sale"><?=$cart->get_sale_price($v['id_product'],$v['soluong'])?></span>
													<span class="price-new-cart-detail"><?=$func->format_money($cart->total_get_price($v['id_product'],$v['soluong']));?></span>
												<?php }?>
	                                		<?php }else{?>
	                                			<?php if($v['giamoi']) { ?>
