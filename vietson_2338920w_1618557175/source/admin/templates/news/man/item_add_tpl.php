...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="<?=$colLeft?>">
                <?php if(isset($config['news'][$type]['user_group']) && $config['news'][$type]['user_group'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Chọn thành viên</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group-category">
                                <?=$func->get_user_group(@$item['id'], 'user_group', 'news', $type)?>
                            </div>
                        </div>
                    </div>
                <?php }?>
